...
from depth_prior.lib.utils.logging import log_stats
from depth_prior.lib.utils.logging import SmoothedValue
from depth_prior.lib.utils.timer import Timer
...
class TrainingStats(object):
    ...
    def __init__(self, args, log_period=20, tensorboard_logger=None):
        ...
        self.tb_ignored_keys = ['iter', 'eta', 'time']
    ...
    def GetStats(self, cur_iter, cur_epoch, optimizer, val_err = {}):
        ...
        eta = str(datetime.timedelta(minutes=int(eta_seconds/60/1000000)))
        stats = OrderedDict(
